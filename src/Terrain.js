 ...
 *     include `Terrain.Linear` (the default), `THREE.Terrain.EaseIn`,
 *     `Terrain.EaseOut`, `THREE.Terrain.EaseInOut`,
 ...
 *     BufferGeometry instead of THREE.Geometry for the Terrain plane.
 *     Defaults to `false`.
...
export function Terrain(options) {
    ...
    this.material = options.material || new THREE.MeshBasicMaterial({ color: 0xee6633 });
    ...
    if (options.heightmap instanceof HTMLCanvasElement || options.heightmap instanceof Image) {
        this.fromHeightmap(mesh.geometry.vertices, options);
    }
...
Terrain.prototype = Object.assign( Object.create( THREE.Object3D.prototype ), {
   /**
    ...
    */
    fromArray2D: function(vertices, src) {
    ...
    */
    fromArray1D: function(vertices, src) {
    ...
    *   rendered.
    */
    generateBlendedMaterial: function(textures) {
 ...
 */
 Terrain.HeightmapArray = function(method) {
 ...
 * Parameters are the same as those for {@link THREE.Terrain.DiamondSquare}.
 */
Terrain.PerlinLayers = function(g, oiptions) {
    Terrain.MultiPass(g, options, [
